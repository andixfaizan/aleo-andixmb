...
async function deployProgram(program) {
  ...
  const account = new Account({
    privateKey: "APrivateKey1zkp9aGTPv3i8fnon6VkTgYGcWYUcj5CfisLwrnPhisLfRJh",
  });
  ...
  const feeRecord = "{owner: aleo10mdqkramjk4ercpkytwptygs55s4c973zx03rjt202q84m5ulvpsmkasx0.private, microcredits: 50000000u64.private, _nonce: 6308650276201368396889717392302293266880140176094754312976515788040219970923group.public}";
  const tx_id = await programManager.deploy(program, fee, undefined, feeRecord);
  return tx_id;
}
